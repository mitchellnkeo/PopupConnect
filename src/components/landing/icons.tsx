...
export function IconPalette(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden {...props}>
      <path d="M12 3a9 9 0 109 9c0-4-2-6-5-6-1.5 0-2.5.5-3 1.5-.5 1-1 1.5-2 1.5-2 0-3-1.5-3-4 0-3 2-5 4-6z" />
...
export function IconVenueHost(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden {...props}>
...
export function IconOrganizer(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden {...props}>
...
export function LogoMarkLight(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 40 24" fill="none" aria-hidden {...props}>
      ...
      <circle cx="18" cy="12" r="9" fill="white" fillOpacity="0.35" stroke="white" strokeWidth="1.5" />
    </svg>
  );
}
