...
| Explore map | **Done** | Leaflet/OSM; clusters; fit bounds; marker click → preview; vendor geocode on save |
...
| Customer profile | **Partial** | Email-change form shipped; confirmation blocked on custom SMTP |
