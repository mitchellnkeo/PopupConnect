...
PopupConnect system architecture (Supabase Auth, Postgres, RLS) is defined in **[SYSTEM_ARCHITECTURE.md](./SYSTEM_ARCHITECTURE.md)** in `docs/`. Read it before implementing accounts, profiles, or bookings.
...
- Document new tables and policies in [SYSTEM_ARCHITECTURE.md](./SYSTEM_ARCHITECTURE.md) or `supabase/migrations/`.
...
Documentation
Code Documentation
README.md (repo root): Project setup, dependencies, and getting started
docs/: Central documentation — see docs/README.md for index
